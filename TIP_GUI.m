...
% Given an image, the user pick the "inner rectangle" 
...
% click on the vanishing point until the user is satisfied.  When done, hit
% "ENTER".  
...
%  user  specify the vanishing point
while 1
